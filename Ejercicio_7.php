...
<body>
    ...
    <header>
        ...
        <img src="Logo Info Industrial 2021-100.jpg" width="700" height="200" />
    </header>
    <section>
        ...
        ?>
            ...
            list($maIndice) = indice_maximo_minimo();
            list($miIndice) = indice_maximo_minimo();
            ?>
            <br />
            <table border="1" width="700" cellspacing="0" cellpadding="5">
                <tr>
...
function indice_maximo_minimo()
{
    ...
    $maIndice = array_search($minimo, getPromedios());
    return array($maIndice);
    return array($miIndice);
}
?>